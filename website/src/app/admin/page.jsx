...
function Admin() {
  ...
  useEffect(() => {
    ...
    setIsMainAdmin(localStorage.getItem('isMainAdmin') === 'true');
    setIsMounted(true);
  }, []);
  ...
  useEffect(() => {
    if (isMounted) {
      ...
      if (saved) setEditingProduct(JSON.parse(saved));
    }
  }, [isMounted]);
    ...
    <div style={{ display: 'flex', minHeight: '80vh', borderTop: '1px solid var(--color-sand)' }}>
        ...
        <button 
            ...
            >
              ...
              {unreadMessagesCount > 0 && (
                <span style={{ background: 'black', color: 'white', borderRadius: '50%', minWidth: '20px', height: '20px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', fontWeight: 'bold', padding: '0 4px' }}>
                  {unreadMessagesCount}
                </span>
              )}
            </button>
      ...
      <main style={{ flex: 1, padding: '0 3rem 3rem 3rem', background: '#faf9f6' }}>
        ...
        {activeTab === 'homepage' && homepageData && editingSection === null && (
          <div>
            <div style={{ position: 'sticky', top: 0, background: '#faf9f6', paddingTop: '3rem', paddingBottom: '1.5rem', zIndex: 10, margin: '0 -3rem 2rem -3rem', paddingLeft: '3rem', paddingRight: '3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h1 style={{ marginBottom: '0.5rem', marginTop: 0, fontSize: '32px' }}>Manage Homepage</h1>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                ...
                <h1 style={{ margin: 0, fontSize: '32px' }}>Edit Banners</h1>
              </div>
        ...
        {activeTab === 'homepage' && homepageData && editingSection === 'promoCards' && (
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                <button onClick={() => setEditingSection(null)} className="btn btn-outline" style={{ padding: '0.4rem 1rem' }}>&larr; Back</button>
                <h1 style={{ margin: 0, fontSize: '32px' }}>Edit Promo Cards</h1>
              </div>
              <div style={{ display: 'flex', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  {!renamingCategory ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <h1 style={{ margin: 0, fontSize: '32px' }}>Manage: {categories.find(c => c.id === activeTab.replace('products-', ''))?.title || activeTab.replace('products-', '')}</h1>
                      <button 
                        onClick={() => {
        ...
        {activeTab === 'messages' && (
          <div>
            <div style={{ position: 'sticky', top: 0, background: '#faf9f6', paddingTop: '3rem', paddingBottom: '1.5rem', zIndex: 10, margin: '0 -3rem 2rem -3rem', paddingLeft: '3rem', paddingRight: '3rem' }}>
              <h1 style={{ marginBottom: '0.5rem', marginTop: 0, fontSize: '32px' }}>Messages</h1>
            ...
            {messages.length === 0 ? (
              <div style={{ background: 'white', padding: '3rem', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                <div style={{ fontSize: '3rem', marginBottom: '1rem', opacity: 0.2 }}>âœ‰ï¸</div>
        ...
        {activeTab === 'manage-admin' && isMainAdmin && (
          <div>
            <div style={{ position: 'sticky', top: 0, background: '#faf9f6', paddingTop: '3rem', paddingBottom: '1.5rem', zIndex: 10, margin: '0 -3rem 2rem -3rem', paddingLeft: '3rem', paddingRight: '3rem' }}>
              <h1 style={{ marginBottom: '0.5rem', marginTop: 0, fontSize: '32px' }}>Manage Admin Users</h1>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              ...
              <button onClick={() => {setIsAddAdminPopupOpen(false); setNewAdminEmail('');}} style={{ background: 'none', border: 'none', fontSize: '1.5rem', cursor: 'pointer' }}>âœ•</button>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              ...
              <button onClick={() => setSelectingProductFor(null)} style={{ background: 'none', border: 'none', fontSize: '1.5rem', cursor: 'pointer' }}>âœ•</button>
            </div>
